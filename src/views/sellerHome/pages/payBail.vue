<template>
      ...
      <div class="rules">
        ...
        <div class="content">
          ...
          <p class="content__clause">第五章 翼修平台服务费/费率标准</p>
          <p>平台使用费：服务商在翼修经营必须交纳平台服务费，平台服务费主要用于保证商家按照翼修的规则进行经营，并且在商家有违规行为时根据《翼修服务协议》及相关规则规定用于向翼修及消费者支付违约金。续约商家须在当年续签要求的时间内一次性缴纳次年度平台使用费1000元。 </p>    
          <p>新签商家在申请入驻获得批准时一次性缴纳当年度的平台使用费1000元。</p>
          <p>如商家与翼修的协议有效期起始时间均在2018年内的，如商家与翼修的协议有效期跨自然年的。</p>
          <p class="content__clause">第六章 续约</p>
          <p>续签须在合同结束前30天之前完成续签申请的提交，并在合同结束15天之前完成年费的缴纳及平台服务费的锁定，如果上一年及下一年资费及资料未补足，翼修将在7天内监管店铺并清退出翼修平台。</p>
